...
Currently focused on **Data Analysis & Machine Learning**, leveraging **Python, SQL, Pandas, NumPy, Matplotlib**, and **TensorFlow** to extract insights, build **predictive models**, and implement **data-driven solutions**. 
